...
public class AuthController {
    ...
    public ResponseEntity<?> register(@RequestBody Map<String, String> body) {
        var user = new com.fontolan.spring.securitykeyvault.example.domain.model.User();
        user.setUsername(body.get("username"));
        user.setPassword(body.get("password"));
        user.setRoles(java.util.Set.of(com.fontolan.spring.securitykeyvault.example.domain.model.Role.ROLE_USER));
